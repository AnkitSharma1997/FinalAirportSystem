...
{
	var zipCode=document.updatePilot.pilotZipCode.value;
	var ssn=document.updatePilot.pilotSsn.value;
	if(zipCode==0)
	{
...
<springform:form id="shift" modelAttribute="view1PilotModel" method="post" action="editPilot.htm" 
name="updatePilot" onsubmit="return checkZero(event)" style="border:10px solid black;">

<div class="w3-center">
<header id="edit">
  <h2><b>Update Pilot</b></h2>
</header></div>

<div class="w3-row">
<div class="w3-col s6">
<springform:label path="pilotId" class="edit">Pilot Id</springform:label>
<springform:input path="pilotId" class="w3-input w3-border" style="width:80%" disabled="true"/>
</div>

<div class="w3-col s6">
<springform:label path="pilotLicenseNumber" class="editLicense"><b>License Number</b></springform:label>
<springform:input path="pilotLicenseNumber" class="w3-input w3-border" style="width:70%" autocomplete="off"
...
<springform:input path="pilotCity" class="w3-input w3-border" style="width:80%" onkeypress="return alphabetOnly(event)"
maxlength="50" autocomplete="off" placeholder="City" />
...
<springform:input path="pilotState" class="w3-input w3-border" style="width:70%" maxlength="50" 
