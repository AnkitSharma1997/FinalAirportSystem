  ...
  <div class="w3-row-padding">
   ...
   <div class="w3-rest">   
    ...
    <div class="w3-row-padding w3-center w3-margin-bottom" >   
     ...
     <center><div class="w3-container" style="width:100%;background: rgba(255, 255, 255, 0.7);font-weight: bolder;color:black;"><br>
    <div class="w3-responsive">
  	<table class="w3-table-all w3-hoverable w3-centered">
		<tr style="background-color: #ffb366;">
			...
			<th class="editText">Occupancy from date</th>
			<th class="editText">Occupancy till date</th>
			<th></th>
			<th></th>
		</tr>
		<c:forEach items="${hangarStatusList}" var="hangarStatus">
			<tr style="opacity: 0.8">
				...
				<td><c:out value="${hangarStatus.managerId}" /></td>
				<td><c:out value="${hangarStatus.status}" /></td>
				<td><c:out value="${hangarStatus.occupancyFromDate}" /></td>
				<td><c:out value="${hangarStatus.occupancyTillDate}" /></td>	
								
				<td><a href="hangarAllocationForm.htm?hangarId=${hangarStatus.hangarId}&managerId=${hangarStatus.managerId}"
				style="text-decoration: none;color: #ff8000;"><i class="fa fa-plus"></i>&nbsp;Allocate</a></td>
				
				<td><a href="viewOneHangarStatus.htm?hangarId=${hangarStatus.hangarId}"
				style="text-decoration: none;color:#0059b3"><i class="fa fa-exchange"></i>&nbsp;Update Status</a>
