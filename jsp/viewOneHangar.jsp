...
<springform:form modelAttribute="view1HangarModel" method="post" action="editHangar.htm"
name="updateHangar" onsubmit="return checkZero(event)">

<div class="w3-center">
<header id="edit">
  <h2><b>Update Hangar</b></h2>
</header></div>

<div class="w3-row">
<div class="w3-col s6" style="padding-left: 8%;">
<springform:label path="hangarId" class="textedit">Hangar Id</springform:label>
<springform:input path="hangarId" disabled="true" class="w3-input w3-border"
style="width:83%" maxlength="10" placeholder="HangarId" /></div>

<div class="w3-col s6">
<springform:label path="managerId" class="textedit">Manager Id</springform:label>
<springform:input path="managerId" disabled="true" class="w3-input w3-border" onkeypress="return alphabetOnly(event)"
style="width:83%" maxlength="10" placeholder="ManagerId" /></div></div>
...
<springform:input path="managerAddressLine1" class="w3-input w3-border" style="width:90%" maxlength="100" 
...
<springform:input path="managerAddressLine2" class="w3-input w3-border" style="width:90%" maxlength="100" 
autocomplete="off" placeholder="Address Line 2"/>

<div class="w3-row">
<div class="w3-col s4" style="padding-left: 8%;">
<springform:label path="hangarCity" class="textedit">City</springform:label>
<springform:input path="hangarCity" class="w3-input w3-border" style="width:80%" maxlength="50" autocomplete="off"
onkeypress="return alphabetOnly(event)" placeholder="City" />
...
<springform:input path="hangarState" class="w3-input w3-border" style="width:80%" autocomplete="off" 
onkeypress="return alphabetOnly(event)" maxlength="50" placeholder="State" />
...
<springform:input path="hangarZipCode" class="w3-input w3-border" autocomplete="off" style="width:80%" maxlength="11" 
...
<p>
<div class="w3-row">
<div class="w3-col s6" style="padding-left:25%;">
