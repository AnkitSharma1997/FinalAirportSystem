...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card" id="myNavbar">
      ...
      <a class="w3-bar-item" style="padding:16px;"><i class="fa fa-home"></i>&nbsp;<b>HANGAR</b></a>
    ...
    <div class="w3-rest">
      ...
      <div class="w3-container w3-margin-bottom" >
		...
		<div class="w3-quarter w3-right" style="width:15%;" >
 		  <a href="viewHangars.htm" style="text-decoration: none;">
 		<div class="w3-card w3-container" style="background: rgba(255, 255, 255, 0.6);min-height:100px;">
		  <h3 class="edit">View Hangars</h3>
		  </div></a>
		</div>

        <div class="w3-quarter w3-right"  style="width:15%;">
	    <a href="hangarForm.htm" style="text-decoration: none;">
  		<div class="w3-card w3-container" style="background: rgba(255, 255, 255, 0.6);min-height:100px">
  			<h3 class="edit">Add Hangars</h3>
  		</div></a>
		</div>
	
		<div class="w3-quarter w3-display-bottomleft" style="width:15%;padding-right: 2%;">
