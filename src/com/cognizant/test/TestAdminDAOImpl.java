...
public class TestAdminDAOImpl
{
	...
	@Mock
	private SessionHelper mockedSessionFactory;
	...
	public void init() throws Exception {
		 MockitoAnnotations.initMocks(this);
		   ...
		   adminDAOImpl.setSessionHelper(this.sessionHelper);
			Mockito.when(mockedSessionFactory.createSession()).thenReturn(mockedSession);
